...
const CompanyGallery = () => {
  const galleryImages = [
    '/images/atGoogle2.jpg',
    '/images/atGoogle.jpg',
    '/images/atGoogle3.jpg',
    '/images/atGoogle4.jpg',
    '/images/atGoogle5.jpg',
  ];
  ...
  return (
    <div className="company-gallery">
      ...
      <div className="gallery-arrow-container">
        <button
          className={`gallery-arrow-btn prev-btn ${currentIndex === 0 ? 'disabled' : ''}`}
        ...
        <button
          className={`gallery-arrow-btn next-btn ${currentIndex >= galleryImages.length - 2 ? 'disabled' : ''}`}
