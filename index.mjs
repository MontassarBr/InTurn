...
app.get("/data2", (req, res) => {
    ...
    let { sql1, sql2, sql3, params, paramsDesc } = buildInternshipQuery(filters, offset);
...
function buildInternshipQuery(filters, offset) {
    ...
    return { sql1: titleQuery, sql3: descriptionQuery, sql2: countQuery, params, paramsDesc };
}
...
app.patch("/track2", (req, res) => {
    ...
    executeUpdateQuery(res, sql, [status, studentID, internshipID, applicationDate]);
});
